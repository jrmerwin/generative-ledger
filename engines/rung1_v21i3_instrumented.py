...
def grow_native(*, final_epoch=100, seed=101, p_ext=0.75, m_defects=0,
    ...
    for epoch in range(1, final_epoch + 1):
        ...
        served_f = served_v = deferred_f = 0; core_flips = 0; wedge_info = None; vd = 0
        ...
        if core:
            ...
            if backlog >= gamma and gamma > 0:
                ...
                if _nt>0:
                    k_stitch+=1
                    wedge_info=dict(n_removed=2*_coll,n_tagged=_nt,pop_trig=_tagtrig)
        ...
        epoch_log.append(dict(epoch=epoch, gamma=gamma, core_faces=len(core),
            ...
            pop_trig=(wedge_info or {}).get("pop_trig", 0),
            vac_demand=vd,
